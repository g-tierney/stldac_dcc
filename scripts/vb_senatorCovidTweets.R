...
print(dim(senTweets116_2020.dfm))
...
print(dim(senTweets116_2020.dfm_trimmed))
...
#rm(senTweets116,senTweets116_2020,senTweets116_2020.dfm)

save(senators,senTweets116_2020.dfm_trimmed,file="senatorTweet_data/rinputs.Rdata")

#senator_vb <- stldac_vb(users=senators[1:10000],dw=convert(senTweets116_2020.dfm_trimmed,to = "matrix")[1:10000],nT = 30,nC = 4,tol = .01,seed = 1,maxiter = 2)
